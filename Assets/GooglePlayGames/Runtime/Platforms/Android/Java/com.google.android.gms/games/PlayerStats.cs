...
namespace GooglePlayGames.Android.Java {
    ...
    internal static class PlayerStats {
        ...
        internal sealed class Instance : JOI {
            ...
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getAverageSessionLength()");
                return Call<float>("getAverageSessionLength");
            }

            public float GetChurnProbability()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getChurnProbability()");
                return Call<float>("getChurnProbability");
            }

            public int GetDaysSinceLastPlayed()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getDaysSinceLastPlayed()");
                return Call<int>("getDaysSinceLastPlayed");
            }

            public float GetHighSpenderProbability()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getHighSpenderProbability()");
                return Call<float>("getHighSpenderProbability");
            }

            public int GetNumberOfPurchases()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getNumberOfPurchases()");
                return Call<int>("getNumberOfPurchases");
            }

            public int GetNumberOfSessions()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getNumberOfSessions()");
                return Call<int>("getNumberOfSessions");
            }

            public float GetSessionPercentile()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getSessionPercentile()");
                return Call<float>("getSessionPercentile");
            }

            public float GetSpendPercentile()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getSpendPercentile()");
                return Call<float>("getSpendPercentile");
            }

            public float GetSpendProbability()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getSpendProbability()");
                return Call<float>("getSpendProbability");
            }

            public float GetTotalSpendNext28Days()
            {
                Logger.t($"JNI: Calling {FullyQualifiedClassName}.getTotalSpendNext28Days()");
